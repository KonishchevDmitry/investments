...
<a name="foreign-income-jurisdiction"></a>
#### Страна дохода

Все доходы от зарубежных брокеров программа декларирует со страной дохода — США. Формально, это не очень корректно, т.
к. по идее дивидендный доход должен декларироваться со страной эмитента, а не брокера, но т. к. в случае чего доказывать
получение дохода и факт удержания налога по нему мы будем по отчетам брокера, то и доход в данном случае лучше
декларировать как доход полученный от брокера.
